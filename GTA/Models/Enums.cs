namespace GrandTheftAccessibility
{
    ...
    /// <summary>
    /// Stage of the aircraft autopilot in AircraftLandingMenu. The engine's
    /// landing tasks only fly the last part of an approach, so the menu drives
    /// them through these stages itself and narrates each transition.
    /// </summary>
