...
namespace GrandTheftAccessibility
{
    ...
    public static class VehicleDescriber
    {
            ...
            new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "scarab", "The Apocalypse Scarab: a low, fully tracked armoured machine, closer to a small tank than a lorry. Two continuous tracks run its whole length with the road wheels visible inside them, and there is no wheel at the front at all. Enormously heavy and nearly unstoppable in a straight line, though it tops out around 75 miles an hour. Rusted scrapyard finish - bare welded plate, exposed hardware, towing hooks, a winch and a tow shackle at the back. Takes body spikes and saw blades. It also takes a rack the game calls Load-a-Spears: a fan of long thin spears standing higher than the vehicle itself and sweeping back over the hull, which from a distance reads as a bundle of radio masts and is in fact a quiver of weapons. Inside it is a tank cockpit rather than a cab: you see out through a narrow horizontal vision slit with a structural bar across the middle of it, so the view is deliberately awful. The dash belongs in an aircraft - guarded toggle switches for ignition, accessory and fuel pump, a large red start button, digital readouts and round fuel and oil gauges. Unusually for this lineup it copies a real machine rather than a film car: the Howe and Howe Ripsaw, an American tracked vehicle whose whole point is being fast on tracks." },
            ...
            { "scarab2", "The Future Shock Scarab: the same tracked machine with clean bodywork instead of rust - smooth painted panels, carbon fibre bumper trim and a hexagonal-patterned bed floor. Drives identically to the Apocalypse version, and of the three it is much the closest to the real Ripsaw it is copying, which is a sleek carbon-panelled thing rather than a scrapyard one." },
